...
md = randomForest_type(type_name="city", type_idx="grp_city", type_set=info$cities, outage_lv=0, en_vd=F)
md = randomForest_type(type_name="town", type_idx="Towns",    type_set=info$towns,  outage_lv=0, en_vd=F)
